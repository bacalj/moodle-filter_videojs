@filter @filter_videojs @filter_videojs_identical_player
Feature: Multiple players on one page will not collide
    ...
    Scenario: Add two players with different sources
        ...
        Then the "src" attribute of "#second-video .vjs-tech" "css_element" should contain "activity-and-resource-controls"
